...
<head>
    ...
    <script type="text/javascript">
        function checkVerificationCode() {
            $.postJSON("/checkVerificationCode", {verifyCode: $("#verify").val()}, function (res) {
                console.info(res.success)
                if (res.success) {
                    Alert.success("验证码正确!");
                    parent.loadRightPage(console.info(res));
                }
            })
        }
                ...
                <form action="${ctx}/web/loginChack" method="post">
                    ...
                    <div style="" class="form_text_iptcha">
                        <div class="captcha_input">
                            <input style="width:80%" name="validateCode" id="verify" onblur="checkVerificationCode()" placeholder="验证码" type="text"
                                   required="required">
                        </div>
                        <div class="captcha_img">
                            <img src="${ctx}/getYzmImage" style="width: 100px;height: 45px;" alt="验证码">
                        </div>
                    </div>
                    <div style="" class="ececk_warning"><span>数据不能为空</span></div>
                    <!--验证码结束-->
